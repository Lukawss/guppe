...
de entrada, que neste caso é o caminho parao arquivo a ser lido. Esssa função retorna
um _io.TextIOWrapper e é com ele que trabalhamos então.

https://docs.python.org/3/library/functions.html#open

# OBS: Por padrão, a função open() abre o arquivo par leitura. Este arquivo
