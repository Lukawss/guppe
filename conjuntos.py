...
_ Conjuntos em qualquer linguagem de programação, estamos fazendo referência à Teoria dos Conjuntos
da Matemática.
...
- Elementos não são acessados por índice, ou seja, conjuntos não são indexados;
...
# Conjuntos não avceitam valores duplicados, então temos 8 elementos
...
# Imagine que fizemos um formula´rio de cadastro de visitantes em uma feira ou museu e os visitantes
...
# {'Pedro', 'Ana', 'Marcos', 'Ellen', 'Fernando', 'Gustavo', 'Guilherme', 'Julia', 'Patricia'}
#unicos1 = estudantes_java.union(estudantes_python)
# {'Gustavo', 'Fernando', 'Ana', 'Patricia', 'Marcos', 'Pedro', 'Guilherme', 'Julia', 'Ellen'}
