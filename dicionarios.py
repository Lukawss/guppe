...
Dicionários são coleções do tipo valor/valor.

Diciónarios são representados por chaves {}.

print(type({}))

OBS: Sobre dicionários
    - Chave e valor são separados por dois pontos 'chave:valor';
    - Tanto chave quanto valor podem ser de qualquuer tipo de dado;
...
# Tuplas por exemplo são bastante interessantes de serem utilizadas como chave de dicionários, pois as mesma
# são imutáveis

localidades = {
    (35.6895, 39.6917): 'Escritório em Tókio',
    (40.7128, 74.0060): 'Escritório em Tókio',
    (37.7749, 122.4194): 'Escritório em Tókio'
}

print(localidades)
print(type(localidades))

# Adicionar elementos em um diciónario
...
# OBS 1: Aqui precisamos SEMPRE informar a chave, e caso não encontrado o elemento, um KeyError é retornado.
...
# Imagine que você tenha um comércio eletrônico, onde temos um carinho de comprars na qual adicionamos produtos.
...
# Teríamos que saber qual é índice de cada informação no produto.
...
# Desta forma, facilmente adicionamos ou removemos produtos no carinho e em cada produto
