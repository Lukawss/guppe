...
OBS: Se você escrever uma função que realiza várias tarefas denttro dela;
...
nome_da_funcao -> SEMPRE, com letras minúscula, e se for nome composto, separado por underline (Snake Case);
parametros_de_entrada -> Opcionais, onde tendo mais de um, cada um sepatrado por vírgula, podendo ser opcionais ou não;
