...
Tuplas bastantes parecidas com listas.
...
operação em uma tuplas gera uma nova tupla.
...
# OBS: Gera erro (ValueError) se colocarmos um número difrente de elementos para desenpacotar.
...
# OBS: caso o elemtento não exista, será gerado ValueError

# Por quê utilizar tuplas?

# - Tuplas são mais rápidas de que listas.
# - Tuplas deixam seu código mais segura*.

# * Isso porque trabalhar com elementos imutáveis tras segurança ao código.
