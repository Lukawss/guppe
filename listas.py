...
Listas em Python  funciona funciona como vetores/matrizes (arrays) em outras linguagens, com a diferença
...
- Qualquer tipo de dado: A listas não possuem tipo de dado fixo; Ou seja, podemos colocar qualquet tipo de dado;
...
# lista1.append(42) # ERRO

lista1.append([23, 24, 25]) # Coloca a lista como elemento único (sublista)
print(lista1)

if [23, 24, 25] in lista1:
...
# Por padrão, o split separar os elementos da lista pelo espaço entre elas.
...
# Covertendo uma lista em uma string
...
lista6 = [1, 2.34, True, 'Geek', 'd', [1, 2, 3], 453453453]
print(lista6)
print(type(lista6))
...
# Fazemos acesso aos elementos de forama indexada
#          0         1         2        3
...
# o final de uma elemento está ligado ao início da list

print(cores[-1]) # branco
print(cores[-2]) # azul
print(cores[-3]) # amarelo
print(cores[-4]) # verde
# print(cores[-5]) # Erro, pois não eciste índice -5
...
# Podemos fazer busca dentro de uma lista, ou seja, qual índice começar a buscar
...
# Podemos fazer busca dentro de uma lista, inicio/fim
print(numeros.index(8, 3, 6)) # Buscar indice do valor 8, entre os índices 3 a 6
...
# Trabalhando com slice de lista como o parâmetro 'inicio'
...
# OBS: Se tivermos um número diferentes na lista ou variáveis para receber os dadosz, teremos ValueError
...
# Isso em Pythoné chamdo de Shallow Copy.
