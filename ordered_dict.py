"""
Módulo Collections: Ordered Dict   https://docs.python.org/3/library/collections.html#collections.OrderedDict

# Em um dicionario, a orde de inserção dos elementos não é garantida.
